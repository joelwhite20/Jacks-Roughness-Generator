...
def exporter(A, phi, lambda_k, N, M, pts_perturbed, pts0, folder, file_name):
    """
    ...
    df_pts0.to_excel(writer, sheet_name='Original Points', index=False,header=0)
